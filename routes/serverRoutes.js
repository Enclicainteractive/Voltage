...
router.put('/:serverId/guild-tag', authenticateToken, async (req, res) => {
  ...
  if (guildTag !== undefined) {
    if (guildTag === null || guildTag === '') {
      ...
      const blacklist = [
        // N-word variants
        'nigger', 'nigga', 'nigr', 'nigg', 'niga', 'nigger', 'niggu', 'nigrs', 'niggas',
        'n1gr', 'n1gg', 'n!gr', 'n!gg', 'nigg', 'n1g', 'ngr', 'ngg', 'n!g', 'n166', 'n1g6', 'nig', 'n16', 'n!6',
        'n3gr', 'n3gg', 'ngro', 'nggr', 'negr', 'negg', 'naig', 'naig', 'nygr', 'nygg',
        // F-slur variants
        'faggot', 'fagt', 'fags', 'fag', 'fgt', 'fagg', 'fagger', 'faggy',
        'fagt', 'fggt', 'f4gt', 'f@gt', 'f4g', 'fag', 'f@g', 'f4gg', 'fagg', 'f@gg', 'f4g7', 'fa67', 'f@67', 'fgt', 'f67',
        'f@ck', 'fack', 'facist', 'fascist',
        // C-slur variants
        'cunt', 'cunts', 'cuntz', 'cun', 'cunts', 'cunted', 'cunting',
        'cunt', 'cun7', 'cu n7', 'cvnt', 'cv nt', 'c0nt', 'cnt', 'cunt', 'cun7', 'cuNT', 'cVNT',
        // Chink variants
        'chink', 'chink', 'chin', 'chnk', 'chinka',
        'chnk', 'ch1nk', 'ch!nk', 'chnk', 'ch!k', 'ch1k',
        // Spic variants
        'spic', 'spics', 'spig', 'spick', 'spik',
        'spic', 'sp1c', 'sp!c', 'spik', 'sp1k', 'sp!k', 'spck',
        // Kike variants
        'kike', 'kikes', 'kik', 'kyke',
        'kike', 'k1ke', 'k!ke', 'kyke', 'k1k', 'kyk',
        // Gook variants
        'gook', 'gooks', 'gook', 'gooky',
        'gook', 'g00k', 'g0ok', 'go0k', 'guk', 'g00k',
        // Coon variants
        'coon', 'coons', 'coon', 'coony',
        'coon', 'c00n', 'co0n', 'c0on', 'c0n',
        // Dyke variants
        'dyke', 'dykes', 'dike',
        'dyke', 'dyk3', 'd1ke', 'd!ke',
        // Twat variants
        'twat', 'twats', 'twat', 'twat',
        'twat', 'tw4t', 'tw@t', 'twa7',
        // Slut variants
        'slut', 'sluts', 'slutz', 'slutty',
        'slut', '$lut', 'slu7', '$lu7', 'sl0t',
        // Whore variants
        'whore', 'whores', 'whore', 'whor',
        'whre', 'wh0r', 'w4or', 'wh0re',
        // Dick variants
        'dick', 'dicks', 'diks', 'dik', 'dicky',
        'dick', 'd1ck', 'd!ck', 'dck', 'dik', 'd1k',
        // Cock variants
        'cock', 'cocks', 'cok', 'cock', 'cockey',
        'cock', 'c0ck', 'c0k', 'cok', 'cockk',
        // Cum variants
        'cum', 'cums', 'cumming', 'cummed',
        // Pussy variants
        'pussy', 'puss', 'pusy', 'pus', 'pussys', 'pussi',
        // Shit variants
        'shit', 'shits', 'shid', 'shyt', 'sh1t', 'shiit',
        'shit', 'sh1t', '$hit', '$h1t', 'sh!t', 'shi7', '$hi7',
        // Fuck variants
        'fuck', 'fucks', 'fuk', 'fukk', 'fucker', 'fucked', 'fucking',
        'fuck', 'fuk', 'fukk', 'f0ck', 'fu ck', 'fck', 'fcuk', 'phuk', 'fucc', 'fuked', 'fukin',
        'f@ck', 'f@k', 'f@@k', 'fuck',
        // Ass variants
        'ass', 'asses', 'azz', 'asshole', 'ashol', 'ashole',
        'ass', '@ss', '4ss', 'a55', '@55',
        // Piss variants
        'piss', 'pissed', 'pissing',
        'piss', 'p1ss', 'p!ss', 'pi55', 'p155',
        // Rape variants
        'rape', 'raped', 'rapes', 'rapist', 'raping',
        'rape', 'r4pe', 'rap3', 'r4p3', 'rpe',
        // Kill variants
        'kill', 'killed', 'killing', 'kills',
        'kill', 'k1ll', 'ki ll', 'kll', 'kil', 'k1l', 'k!l',
        // Nazi variants
        'nazi', 'nazis', 'nazi', 'natz', 'natzism',
        'nazi', 'n4z1', 'naz1', 'n4zi', 'nazz', 'natzi',
        // Hate variants
        'hate', 'hated', 'hates', 'hating',
        'hate', 'h8', 'h4te', 'hat3', 'h8te',
        // Pedo variants
        'pedo', 'pedos', 'pedophile', 'pedo', 'pederast',
        'pedo', 'p3do', 'ped0', 'p3d0', 'pdo',
        // Loli/Shota
        'loli', 'loli', 'lolicon', 'shota', 'shotacon',
        'loli', 'l0l1', 'lo l1', 'loly', 'shot', 'sh0t',
        // Drug variants
        'meth', 'meth', 'methamphetamine', 'coke', 'cocaine', 'fent', 'fentanyl', 'mdma', 'dope',
        'meth', 'm3th', 'coke', 'c0ke', 'fent', 'mdma', 'dope', 'd0pe', 'blow', 'bl0w', 'drug', 'dr0g',
        // Extremist
        '1488', '88', 'kkk', 'isis', 'isil', 'nazi', 'klan', 'jihd', 'jihad', 'bomb', 'terror',
        '1488', '14/88', '88', 'kkk', 'isis', 'isil', 'na zi', 'klan', 'jhd', 'bomb', 'b0mb',
        // Other slurs and offensive
        'wetback', 'wetb', 'wetback',
        'fucker', 'fuck', 'fuk', 'fukk', 'fuk',
        'retard', 'retarded', 'retard', 'retar', 'reta', 'tard',
        'bastard', 'bastards', 'bast', 'basrd',
        'whore', 'whor', 'whores',
        'bitch', 'bitches', 'bich', 'bitc', 'btch', 'b1tch',
        'slut', 'sluts', 'slutz',
        'dumb', 'dum', 'idiot', 'idiots', 'moron', 'morons',
        'imbecil', 'imbecile', 'loser', 'losers',
        'pervert', 'perverts', 'pedo', 'pedos',
        'hitler', 'hiter', 'hitler',
        'terrorist', 'terror', 'taliban',
        'isis', 'isil',
        'anal', 'anus', 'arse', 'arses',
        'blowjob', 'bollocks', 'boner',
        'boob', 'boobs', 'bra', 'bras',
        'bullshit', 'clit', 'cooch',
        'ejaculate', 'erection',
        'fart', 'fck', 'fcuk', 'feck', 'felch',
        'femdom', 'gangbang', 'genital',
        'homo', 'homosexual', 'jap', 'japs',
        'jerk', 'jizz', 'kink', 'knob',
        'lmao', 'lmfao', 'masturbat',
        'muff', 'naked', 'nipple', 'nsfw',
        'orgasm', 'p0rn', 'porn', 'prick',
        'pube', 'queer', 'satan', 'scrotum',
        'sex', 'shag', 'skank', 'slag',
        'sodom', 'spank', 'sperm', 'spunk',
        'testicle', 'tits', 'vagina', 'wank',
        'wazoo', 'weenie', 'weiner', 'wiener',
        'wtf', 'xxx', 'doxx', 'd0xx',
        'swat', '$wat', 'ddos', 'hack', 'h4ck',
        'gore', 'g0re', 'snuf', 'necr', 'pron', 'pr0n',
        'coon', 'tranny', 'trans', 'homo', 'faggot',
        'chink', 'gook', 'spic', 'kike', 'wetback',
        'beaner', 'brownie', 'sambo', 'jungle bunny',
        'zipperhead', 'oriental', 'raghead',
        'white power', 'supremacy', 'aryan',
        'kkk', 'nazi', 'heil', 'sieg',
        'jihad', 'terrorist', 'bin laden',
        'osama', 'taliban', 'al qaeda',
        'pedo', 'molest', 'incest',
        'rape', 'rapist', 'molest',
        'suicide', 'kms', 'kill self',
        'die', 'death', 'murder'
      ]
